...
class BuildColor {
  ...
  ///```
  Color get selectedRow => Theme.of(_context).dataTableTheme.dataRowColor?.resolve({WidgetState.selected}) ??
      Theme.of(_context).colorScheme.primary.withOpacity(0.12);
